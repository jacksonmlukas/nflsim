...
def __import_rosters(release, years, columns=None):
    ...
    rosters = pandas.concat([pandas.read_parquet(uri.format(y)) for y in years])
...
def import_ids(columns=None, ids=None):
    ...
    # import data
    df = pandas.read_csv(
        r"https://raw.githubusercontent.com/dynastyprocess/data/master/files/db_playerids.csv"
    )
