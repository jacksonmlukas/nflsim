...
def check_types(
    ...
    *,
    ...
    def _get_annotated_schema_models(
        ...
        str,
        Iterable[tuple[Union[DataFrameModel, None], Union[AnnotationInfo, None]]],
    ]:
            ...
            if not annotation_info.is_generic_df:
                ...
                if annotation_info.origin == Union:
                    ...
                    for annot in annotation_info.args:  # type: ignore[union-attr]
                        ...
                        schema_model = cast(DataFrameModel, sub_annotation_info.arg)
                ...
                if (
                    ...
                    try:
                        ...
                        error_handler.collect_error(
                            validation_type(errors.SchemaErrorReason.INVALID_TYPE),
