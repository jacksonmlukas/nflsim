...
class Expression:
    ...
    def __eq__(self, expr: "Expression") -> "Expression": ...  # type: ignore[override]
    def __ne__(self, expr: "Expression") -> "Expression": ...  # type: ignore[override]
...
def LambdaExpression(
    lhs: Union[Tuple["Expression", ...], str], rhs: Expression
) -> Expression: ...
...
class DuckDBPyConnection:
    ...
    def values(
        self, *args: Union[List[Any], Expression, Tuple[Expression]]
    ) -> DuckDBPyRelation: ...
    def table_function(
...
class DuckDBPyRelation:
    ...
    def update(
        self, set: Dict[str, Expression], condition: Optional[Expression] = None
    ) -> None: ...
    ...
    def map(
        self, map_function: function, schema: Optional[Dict[str, DuckDBPyType]] = None
    ) -> DuckDBPyRelation: ...
...
def connect(
    database: Union[str, Path] = ..., read_only: bool = ..., config: dict = ...
) -> DuckDBPyConnection: ...
...
def register_filesystem(
    filesystem: fsspec.AbstractFileSystem, *, connection: DuckDBPyConnection = ...
) -> None: ...
def unregister_filesystem(
    name: str, *, connection: DuckDBPyConnection = ...
) -> None: ...
def list_filesystems(*, connection: DuckDBPyConnection = ...) -> list: ...
def filesystem_is_registered(
    name: str, *, connection: DuckDBPyConnection = ...
) -> bool: ...
def create_function(
    name: str,
...
def struct_type(
    fields: Union[Dict[str, DuckDBPyType], List[str]],
    *,
    connection: DuckDBPyConnection = ...,
) -> DuckDBPyType: ...
def row_type(
...
def table(
    table_name: str, *, connection: DuckDBPyConnection = ...
) -> DuckDBPyRelation: ...
def view(
    view_name: str, *, connection: DuckDBPyConnection = ...
) -> DuckDBPyRelation: ...
def values(
    *args: Union[List[Any], Expression, Tuple[Expression]],
    connection: DuckDBPyConnection = ...,
) -> DuckDBPyRelation: ...
def table_function(
