...
def test_groupby_raises_datetime(
    ...
    klass, msg = {
        ...
        "skew": (
            TypeError,
            "dtype datetime64\\[ns\\] does not support reduction|datetime64 type does not support skew operations",
        ),
        "std": (None, ""),
...
def test_groupby_raises_category(
    ...
    klass, msg = {
        ...
        "mean": (
            TypeError,
            "'Categorical' .* does not support reduction 'mean'|category dtype does not support aggregation 'mean'",
        ),
        "median": (
            TypeError,
            "'Categorical' .* does not support reduction 'median'|category dtype does not support aggregation 'median'",
        ),
        "min": (None, ""),
        "ngroup": (None, ""),
        "nunique": (None, ""),
        ...
        "sem": (
            TypeError,
            "'Categorical' .* does not support reduction 'sem'|category dtype does not support aggregation 'sem'",
        ),
        "shift": (None, ""),
        "size": (None, ""),
        "skew": (
            TypeError,
            "dtype category does not support reduction 'skew'|category type does not support skew operations",
        ),
        "std": (
            TypeError,
            "'Categorical' .* does not support reduction 'std'|category dtype does not support aggregation 'std'",
        ),
        "sum": (TypeError, "category type does not support sum operations"),
        "var": (
            TypeError,
            "'Categorical' .* does not support reduction 'var'|category dtype does not support aggregation 'var'",
        ),
    }[groupby_func]
...
def test_groupby_raises_category_on_category(
    ...
    klass, msg = {
        ...
        "skew": (
            TypeError,
            "category type does not support skew operations|dtype category does not support reduction 'skew'",
        ),
        "std": (
            TypeError,
            "'Categorical' .* does not support reduction 'std'|category dtype does not support aggregation 'std'",
