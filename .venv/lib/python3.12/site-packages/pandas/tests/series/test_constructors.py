...
class TestSeriesConstructors:
    ...
    def test_constructor_dtype_timedelta64(self):
        ...
        msg = "Could not convert object to NumPy timedelta|Could not convert 'foo' to NumPy timedelta"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_mismatched_null_nullable_dtype(
        ...
        # GH#44514
        msg = "cannot safely cast non-equivalent object|int\\(\\) argument must be a string, a bytes-like object or a (real )?number|Cannot cast array data from dtype\\('O'\\) to dtype\\('float64'\\) according to the rule 'safe'|object cannot be converted to a FloatingDtype|'values' contains non-numeric NA"
