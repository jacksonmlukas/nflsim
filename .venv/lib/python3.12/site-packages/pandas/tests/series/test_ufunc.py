...
class TestNumpyReductions:
    ...
    def test_multiply(self, values_for_np_reduce, box_with_array, request):
        ...
        if values.dtype.kind in "iuf":
            ...
            msg = "does not support reduction|unsupported operand type|ufunc 'multiply' cannot use operands"
    ...
    def test_add(self, values_for_np_reduce, box_with_array):
        ...
        if values.dtype.kind in "miuf":
            ...
            msg = "does not support reduction|unsupported operand type|ufunc 'add' cannot use operands"
            with pytest.raises(TypeError, match=msg):
                np.add.reduce(obj)
