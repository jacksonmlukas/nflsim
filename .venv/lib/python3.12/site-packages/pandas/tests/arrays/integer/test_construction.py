...
def test_to_integer_array_error(values):
    ...
    msg = "cannot be converted to IntegerDtype|invalid literal for int\\(\\) with base 10:|values must be a 1D list-like|Cannot pass scalar|int\\(\\) argument must be a string"
