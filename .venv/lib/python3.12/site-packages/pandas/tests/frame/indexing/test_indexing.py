...
class TestDataFrameIndexing:
    ...
    def test_setting_mismatched_na_into_nullable_fails(
        ...
        msg = "timedelta64\\[ns\\] cannot be converted to (Floating|Integer)Dtype|datetime64\\[ns\\] cannot be converted to (Floating|Integer)Dtype|'values' contains non-numeric NA|Invalid value '.*' for dtype '(U?Int|Float)\\d{1,2}'"
        with pytest.raises(TypeError, match=msg):
            arr[0] = null
