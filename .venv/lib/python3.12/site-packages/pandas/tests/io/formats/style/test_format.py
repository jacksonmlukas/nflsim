...
@pytest.mark.parametrize(
    ...
    [
        (
            r"$ \$&%#_{}~^\ $ &%#_{}~^\ $",
            "$ \\$&%#_{}~^\\ $ \\&\\%\\#\\_\\{\\}\\textasciitilde \\textasciicircum \\textbackslash \\space \\$",
        ),
        (
            r"\( &%#_{}~^\ \) &%#_{}~^\ \(",
            "\\( &%#_{}~^\\ \\) \\&\\%\\#\\_\\{\\}\\textasciitilde \\textasciicircum \\textbackslash \\space \\textbackslash (",
        ),
        (
            r"$\&%#_{}^\$",
        ...
        (
            r"$ \frac{1}{2} $ \( \frac{1}{2} \)",
            "$ \\frac{1}{2} $ \\textbackslash ( \\textbackslash frac\\{1\\}\\{2\\} \\textbackslash )",
        ),
    ],
)
