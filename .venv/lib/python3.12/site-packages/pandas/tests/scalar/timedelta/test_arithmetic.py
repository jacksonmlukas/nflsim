...
class TestTimedeltaMultiplicationDivision:
    ...
    def test_td_mul_nat(self, op, td_nat):
        # GH#19819
        td = Timedelta(10, unit="d")
        typs = "numpy.timedelta64|NaTType|Timedelta"
        msg = "|".join(
            [
    ...
    def test_td_floordiv_invalid_scalar(self):
        ...
        msg = "Invalid dtype datetime64\\[D\\] for __floordiv__|'dtype' is an invalid keyword argument for this function|this function got an unexpected keyword argument 'dtype'|ufunc '?floor_divide'? cannot use operands with types"
        with pytest.raises(TypeError, match=msg):
...
def test_ops_error_str():
    ...
    for left, right in [(td, "a"), ("a", td)]:
        msg = 'unsupported operand type|can only concatenate str \\(not "Timedelta"\\) to str|must be str, not Timedelta'
        with pytest.raises(TypeError, match=msg):
            left + right
