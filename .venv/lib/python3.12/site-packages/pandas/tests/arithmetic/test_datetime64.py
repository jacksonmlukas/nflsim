...
class TestDatetime64Arithmetic:
    ...
    def test_dt64arr_addsub_intlike(
        ...
        msg = "Addition/subtraction of integers|cannot subtract DatetimeArray from|can only perform ops with numeric values|unsupported operand type.*Categorical|unsupported operand type\\(s\\) for -: 'int' and 'Timestamp'"
    ...
    def test_dt64arr_add_sub_invalid(self, dti_freq, other, box_with_array):
        ...
        dtarr = tm.box_expected(dti, box_with_array)
        msg = "unsupported operand type|cannot (add|subtract)|cannot use operands with types|ufunc '?(add|subtract)'? cannot use operands with types|Concatenation operation is not implemented for NumPy arrays"
    ...
    def test_dt64arr_add_sub_parr(
        ...
        msg = "cannot (add|subtract)|unsupported operand|descriptor.*requires|ufunc.*cannot use operands"
    ...
    def test_dt64arr_addsub_time_objects_raises(self, box_with_array, tz_naive_fixture):
        ...
        msg = "unsupported operand|cannot subtract DatetimeArray from ndarray"
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dti_add_tick_tzaware(self, tz_aware_fixture, box_with_array):
        ...
        for scalar in [pd.offsets.Hour(5), np.timedelta64(5, "h"), timedelta(hours=5)]:
            ...
            msg = "bad operand type for unary -|cannot subtract DatetimeArray"
            with pytest.raises(TypeError, match=msg):
                scalar - dates
