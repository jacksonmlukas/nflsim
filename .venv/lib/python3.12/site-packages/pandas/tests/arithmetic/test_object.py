...
class TestArithmetic:
    ...
    def test_objarr_add_invalid(self, op, box_with_array):
        ...
        msg = "can only concatenate str|unsupported operand type|must be str|has no kernel|operation 'add' not supported|operation 'radd' not supported|operation 'sub' not supported|operation 'rsub' not supported"
