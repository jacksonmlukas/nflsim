...
unicode_alias: dict[str, dict[str, str]] = {
    ...
    "bidipairedbrackettype": {"close": "c", "none": "n", "open": "o"},
    "binary": {
        "ahex": "asciihexdigit",
        "alpha": "alphabetic",
        "bidic": "bidicontrol",
    ...
    "joininggroup": {"hamzaonhehgoal": "tehmarbutagoal"},
    "joiningtype": {
        "dualjoining": "d",
        "joincausing": "c",
        "leftjoining": "l",
    ...
    "nfcquickcheck": {"maybe": "m", "no": "n", "yes": "y"},
    "nfdquickcheck": {"no": "n", "yes": "y"},
    "nfkcquickcheck": {"maybe": "m", "no": "n", "yes": "y"},
    "nfkdquickcheck": {"no": "n", "yes": "y"},
    "numerictype": {"de": "decimal", "di": "digit", "nu": "numeric"},
    "numericvalue": {},
    "script": {
        "adlm": "adlam",
