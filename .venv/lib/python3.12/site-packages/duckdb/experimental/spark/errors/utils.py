...
class ErrorClassesReader:
    ...
    def get_error_message(
        self, error_class: str, message_parameters: Dict[str, str]
    ) -> str:
        """
        ...
        message_parameters_from_template = re.findall(
            "<([a-zA-Z0-9_-]+)>", message_template
        )
    ...
    def get_message_template(self, error_class: str) -> str:
        ...
        if not has_sub_class:
            ...
            if sub_error_class in main_error_class_subclass_info_map:
                sub_error_class_info_map = main_error_class_subclass_info_map[
                    sub_error_class
                ]
            else:
